          ...
          <div class="card-block card-body row">
            <div class=" card-body ">
              <div class="input-group input-group-margin">
                ...
                <span class="form-value">${place.placeDesc}</span>
              </div>
            </div>
          </div>
          <div class="card-block card-body row">
            <div class="card-body" align="right">
              ...
              <div class="btn oli-more-button">
              	<a class="btn-url" href="${contextPath}/secure/ocean/club/placedetail.html?placeId=${(place.placeId!"")?html}"> รายละเอียดเพิ่มเติม</a>
              </div>
            </div>

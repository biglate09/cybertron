...
@Entity(name = "CSS_ADDRESS_SEND")
@SequenceGenerator(name = "CssAddressSendId", sequenceName = "seq_css_address_send", allocationSize = 1)
public class CssAddressSendEntity implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2748309246117836887L;
	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = SEQUENCE, generator = "CssAddressSendId")
	private Long id;
	@Column(name = "pol_no")
	String policyNo;

...
<title><decorator:title default="OceanLife iService"/></title>
	...
	<script>
		var REPORT_URLS={
			download:{
				cert: '${contextPath}/secure/member/document/download/certify.html',
				warn: '${contextPath}/secure/member/document/download/notify.html'
					},
			email:{
				cert: '${contextPath}/secure/member/document/email/certify.html',
				warn: '${contextPath}/secure/member/document/email/notify.html'
				}
		}
	</script>
</head>
<body>
	...
	<div class="under-title-band">
      ...
      <decorator:body />
	<footer class="text-center footer fix-bottome">
